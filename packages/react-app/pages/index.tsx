export default function Home() {
    ...
    return (
        <div className="w-[450px] pb-10  bg-[#040404] mx-auto rounded-xl">
            <img
                src="https://gateway.pinata.cloud/ipfs/QmS53rrbqrCqASx7R3PuNuB9bSCqciKjzEAqsPTske6MYN"
                alt="Silver Plan"
                className="w-[270px] h-[200] mx-auto"
            />
            <div className="px-6">
                <p className="text-white font-bold mb-2">
                    Silver Membership #001
                </p>
                ...
                >
                    {perkComponent("Private forum access")}

                    {perkComponent("Discount on all products")}

                    {perkComponent("Annual conference pass")}

                    {perkComponent("Club Swags")}

                    {perkComponent("Personal Chaufer")}

                    {perkComponent("Free boat rides")}
                </ul>
